    ...
    2899: (e, t, n) => {
      ...
      function g(e, t, n) {
        ...
        return [
          ...
          (0, r.jsx)(
            'script',
            {
              src: `${o}/_next/${(0, c.encodeURIPath)(e)}${u}`,
              nonce: t.nonce,
              async: !a && l,
              defer: !l,
      ...
      function E(e, t) {
        let { scriptLoader: n, disableOptimizedLoading: o, crossOrigin: s } = e,
          ...
          `,
                  ...
                  (o.worker || []).map((e, n) => {
                    let { strategy: r, src: o, children: a, dangerouslySetInnerHTML: u, ...l } = e,
                      c = {};
                    if (o) c.src = o;
                    else if (u && u.__html) c.dangerouslySetInnerHTML = { __html: u.__html };
                    else if (a)
        ...
        return (0, r.jsxs)(r.Fragment, { children: [a, l] });
      }
      class y extends i.default.Component {
        ...
        getCssLinks(e) {
          ...
          if (f.length) {
            let e = new Set(u);
            (p = new Set((f = f.filter((t) => !(e.has(t) || l.has(t)))))), u.push(...f);
          }
          let d = [];
          return (
            u.forEach((e) => {
        ...
        getBeforeInteractiveInlineScripts() {
          ...
          return (e.beforeInteractive || [])
            ...
            .map((e, r) => {
              let { strategy: o, children: s, dangerouslySetInnerHTML: a, src: u, ...l } = e,
                c = '';
              return (
                a && a.__html
                  ? (c = a.__html)
          ...
          P = i.default.Children.map(P || [], (e) => {
            ...
            if (o) {
              ...
              if (
                ...
                return (
                  console.warn(
                    `Found conflicting amp tag "${e.type}" with conflicting prop ${r} in ${u.page}. https://nextjs.org/docs/messages/conflicting-amp-tag`
                  ),
                  null
                );
              ...
              o &&
                (0, r.jsxs)(r.Fragment, {
                  children: [
                    ...
                    !b &&
                      (0, r.jsx)('link', { rel: 'canonical', href: a + n(733).cleanAmpPath(l) }),
                    (0, r.jsx)('link', {
                      rel: 'preload',
                      as: 'script',
...
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
            ...
            if ((0, u.default)(e) && -1 !== e.message.indexOf('circular structure'))
              throw Error(
        ...
        render() {
          ...
          return (0, r.jsxs)(r.Fragment, {
            children: [
              ...
              a && !l && this.getDynamicChunks(p),
              a && !l && this.getScripts(p),
            ],
          });
        }
      }
      function I(e) {
        ...
        return (
          ...
          (function (e, t, n) {
            ...
            let u = [],
              l = Array.isArray(n.children) ? n.children : [n.children],
              c =
                null == (o = l.find((e) => e.type === y))
                  ? void 0
                  : null == (r = o.props)
                    ? void 0
                    : r.children,
    ...
    733: (e, t, n) => {
      ...
      function s(e, t, n = 1 / 0) {
        ...
        function u() {
          let l = Date.now(),
            c = a + t - l;
          c <= 0 || s + n >= l ? ((r = void 0), e.apply(o, i)) : (r = setTimeout(u, c));
        }
        return function (...e) {
          (i = e), (o = this), (a = Date.now()), void 0 === r && ((s = a), (r = setTimeout(u, t)));
        };
      }
    },
    6859: (e, t, n) => {
