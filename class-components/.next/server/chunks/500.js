    ...
    9577: (e, t, r) => {
      ...
      let g = u.default.forwardRef(function (e, t) {
        ...
        let S = u.default.useContext(s.RouterContext),
          ...
          k = !S,
          w = !1 !== m,
          L = null === m ? b.PrefetchKind.AUTO : b.PrefetchKind.FULL,
          { href: N, as: W } = u.default.useMemo(() => {
            if (!S) {
              let e = _(i);
              return { href: e, as: g ? _(g) : e };
            }
            let [e, t] = (0, a.resolveHref)(S, i, !0);
            return { href: e, as: g ? (0, a.resolveHref)(S, g) : t || e };
          }, [S, i, g]),
          D = u.default.useRef(N),
          K = u.default.useRef(W);
        T && (n = u.default.Children.only(r));
        let q = T ? n && 'object' == typeof n && n.ref : t,
          [z, H, F] = (0, p.useIntersection)({ rootMargin: '200px' }),
          $ = u.default.useCallback(
            (e) => {
              (K.current !== W || D.current !== N) && (F(), (K.current = W), (D.current = N)),
                z(e),
                q && ('function' == typeof q ? q(e) : 'object' == typeof q && (q.current = e));
            },
            [W, q, N, F, z]
          );
        u.default.useEffect(() => {}, [W, N, H, M, w, null == S ? void 0 : S.locale, U, k, L]);
        let G = {
          ref: $,
          onClick(e) {
              ...
              U &&
                ...
                (function (e, t, r, n, o, a, i, f, c) {
                  ...
                  let d = () => {
                    let e = null == i || i;
                    'beforePopState' in t
                      ? t[o ? 'replace' : 'push'](r, n, { shallow: a, locale: f, scroll: e })
        ...
        if ((0, f.isAbsoluteUrl)(W)) G.href = W;
          ...
          G.href =
            t || (0, y.addBasePath)((0, c.addLocale)(W, e, null == S ? void 0 : S.defaultLocale));
        }
        return T ? u.default.cloneElement(n, G) : (0, o.jsx)('a', { ...C, ...G, children: r });
      });
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
    ...
    1401: (e, t, r) => {
      ...
      function s(e, t, r) {
        ...
        try {
          ...
          let t = '';
          if ((0, f.isDynamicRoute)(e.pathname) && e.searchParams && r) {
          ...
          return (
            Object.keys(r).forEach((e) => {
              let t = r[e],
                n = o[t.pos];
              void 0 !== n &&
                (a[e] = ~n.indexOf('/') ? n.split('/').map((e) => u(e)) : t.repeat ? [u(n)] : u(n));
            }),
            a
          );
        };
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = n.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                u = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && u) {
                let { key: e, optional: n, repeat: i } = a(u[1]);
                return (
              ...
              {
                let { key: e, repeat: t, optional: n } = a(u[1]);
                return (
